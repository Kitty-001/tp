...
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Archive Mechanism")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("A new class called "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArchivedAddressBook")]),_v(" will be introduced to handle archived entries.")]),_v(" "),_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArchivedAddressBook")]),_v(" will extend the base "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(" class but will be optimized to manage entries that are less frequently accessed or modified.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook")]),_v(" will also maintain a history for the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArchivedAddressBook")]),_v(", allowing undo/redo of archive operations.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Operations")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#archivePerson(Person person)")]),_v(": Archives a person by moving the person entry from the active "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(" to the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArchivedAddressBook")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#restorePerson(Person person)")]),_v(": Restores a person from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ArchivedAddressBook")]),_v(" back to the active "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#getArchivedPersons()")]),_v(": Retrieves a list of all archived persons for display or further actions.")]),_v(" "),_c('li',[_v("These operations will also be added to the command logic so that the user can archive and restore entries using new commands, e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("archive 5")]),_v(" (to archive the 5th person in the list).")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Storage")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("JsonAddressBookStorage")]),_v(" class will be modified to support saving and loading both active and archived data separately. The archived data will be stored in a separate JSON file ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("archivedAddressBook.json")]),_v("), keeping it distinct from the main address book data.")]),_v(" "),_c('li',[_v("When the application starts, both the main and archived address books will be loaded into the system, and changes to either will be saved independently.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("User Interface")]),_v(":")]),_v(" "),_c('ul',[_c('li',[_v("A new tab or section in the UI will be added to display archived entries separately from the main list.")]),_v(" "),_c('li',[_v("Users will be able to toggle between viewing the active address book and the archived address book.")]),_v(" "),_c('li',[_v("Archived entries will have limited actions available, such as restoring or permanently deleting them.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("The user decides to archive an old contact, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(", by executing the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("archive 3")]),_v(". This will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#archivePerson()")]),_v(", moving "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" from the active address book to the archived one and committing the state.")])]),_v(" "),_c('li',[_c('p',[_v("The user later views the archived entries via a command like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("show archived")]),_v(". The application displays a list of archived entries.")])]),_v(" "),_c('li',[_c('p',[_v("If the user wishes to bring back a previously archived contact, they can use the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("restore 2")]),_v(" while viewing the archived list. This restores the contact to the active address book and updates the state history.")])]),_v(" "),_c('li',[_c('p',[_v("If the user clears the active address book, archived entries remain unaffected. This separation ensures that old data is kept while maintaining the flexibility to manage current information.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect")]),_v(": How data is stored and managed.")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 1 (Current Choice)")]),_v(": Store archived data in a separate file ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("archivedAddressBook.json")]),_v(").\n"),_c('ul',[_c('li',[_c('strong',[_v("Pros")]),_v(": Keeps the main address book file smaller, improving performance when accessing active data.")]),_v(" "),_c('li',[_c('strong',[_v("Cons")]),_v(": Requires additional storage logic and structure.")])])]),_v(" "),_c('li',[_c('strong',[_v("Alternative 2")]),_v(": Store archived data in the same file with an \"archived\" flag.\n"),_c('ul',[_c('li',[_c('strong',[_v("Pros")]),_v(": Simplifies storage management as only one file is used.")]),_v(" "),_c('li',[_c('strong',[_v("Cons")]),_v(": Increases file size and complexity when accessing or updating active entries, as all entries (active and archived) are mixed together.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Aspect")]),_v(": User access to archived data.")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 1 (Current Choice)")]),_v(": A separate tab for archived data.\n"),_c('ul',[_c('li',[_c('strong',[_v("Pros")]),_v(": Clear separation in the UI, reducing confusion for users.")]),_v(" "),_c('li',[_c('strong',[_v("Cons")]),_v(": Requires additional UI components and logic.")])])]),_v(" "),_c('li',[_c('strong',[_v("Alternative 2")]),_v(": Filter archived entries within the main view.\n"),_c('ul',[_c('li',[_c('strong',[_v("Pros")]),_v(": Easier to implement with existing UI.")]),_v(" "),_c('li',[_c('strong',[_v("Cons")]),_v(": Could clutter the main view and make it harder to manage active entries.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User requests to add contact")]),_v(" "),_c('li',[_v("GamerBook adds the contact\nUse case ends.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Download the jar file and copy into an empty folder")])]),_v(" "),_c('li',[_c('p',[_v("Run "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar gamerbook.jar")]),_v(" in the Terminal in the _home folder_u Expected: Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by double-clicking the jar file."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])]),_v(" "),_c('li',[_c('p',[_c('em',[_v("{ more test cases …​ }")])])])])}
},function anonymous(
) {
...
with(this){return _c('h2',{attrs:{"id":"appendix-planned-enhancement"}},[_c('strong',[_v("Appendix: Planned Enhancement")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#appendix-planned-enhancement","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"preferred-time-make-overnight-ranges-functional"}},[_v("Preferred Time: Make Overnight Ranges Functional"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#preferred-time-make-overnight-ranges-functional","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Preferred Time currently doesn't accept overnight range, e.g. \"2300-0100\" is currently not accepted.\nSo users cannot add, edit overnight ranges to contacts. Using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findtime")]),_v(" command with overnight ranges\nalso triggers \"invalid command...\" error.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Current workaround with the issue:"),_c('br'),_v("\nFor range input "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("2300-0100")]),_v(", users can break down to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("2300-2359")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("0000-0100")]),_v(". This shall work as valid inputs and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(",\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(", and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("findtime")]),_v(" should be able to work properly with this.")])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"findtime-command-adjustment-on-boundary-overlapping"}},[_v("FindTime Command: Adjustment on Boundary Overlapping"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#findtime-command-adjustment-on-boundary-overlapping","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 23:54:13 GMT+8]")])])])}
}];
